...
def run(
    seed: int, tag: str, model_type: str = "text", epochs: int = 20, exclude_prefixes: tuple = (), **model_kwargs
) -> dict:
    model, history_df = train_model(model_type, seed, epochs, exclude_prefixes=exclude_prefixes, **model_kwargs)
