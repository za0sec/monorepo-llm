...
CSVs -- el ploteo va en plots/plot_presentation_extra.py, por separado.

Uso (desde ejercicio1/): python3 experiments/presentation_extra_eda.py
"""
import pandas as pd
...
campana.to_csv("output/price_position_bought.csv", index=False)
...
z["etapa"] = "z-score"
pd.concat([crudo, z], ignore_index=True).to_csv("output/normalizacion_boxplot.csv", index=False)
...
tag_tabla.to_csv("output/reputation_tag_bought.csv", index=False)
